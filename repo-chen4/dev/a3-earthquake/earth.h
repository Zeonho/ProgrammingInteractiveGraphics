...
public:
    ...
    void DrawEarthquake(double longitude, double latitude, double magnitude, const Matrix4 &model_matrix, const Matrix4 &view_matrix, const Matrix4 &proj_matrix);
    
    void DrawPlane(const int nslices, const int nstacks);
    
    void DrawGlobe(const int nslices, const int nstacks);
    
    void setGlobeMode(bool m) { GlobeMode = m; }
    
    bool getGlobeMode() { return GlobeMode; }
