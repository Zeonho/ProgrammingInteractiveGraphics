...
void AngryVectors::DrawUsingOpenGL() {
    ...
    // arrow
//    Point3 arrow_pos = CalcBirdPos(time_);
//    Point3 arrow_dir = 0;
//    quick_shapes_.DrawArrow(const mingfx::Matrix4 &modelMatrix, <#const mingfx::Matrix4 &viewMatrix#>, <#const mingfx::Matrix4 &projectionMatrix#>, const mingfx::Color &color, <#mingfx::Point3 p#>, <#mingfx::Vector3 dir#>, <#float radius#>)
    ...
    // Solution
    Vector3 dir = CalcBirdPos(time_+0.1) - CalcBirdPos(time_);
    dir = 4.0 * dir.ToUnit();
    quick_shapes_.DrawArrow(identity, view_matrix_, proj_matrix_, Color(1,1,0), bird_pos, dir, 0.1);
