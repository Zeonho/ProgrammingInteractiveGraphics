...
DanceApp::DanceApp() : GraphicsApp(1280,768, "So You Think Ants Can Dance") {
    ...
    ballet_special2_.LoadFromAMC(Platform::FindFile("05_02.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special2_.TrimFront(400);
    ballet_special2_.TrimBack(200);
    ballet_special2_.CalcRelativeTranslations();

    ballet_special3_.LoadFromAMC(Platform::FindFile("05_04.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special3_.TrimFront(280);
    ballet_special3_.TrimBack(200);
    ballet_special3_.CalcRelativeTranslations();

    ballet_special4_.LoadFromAMC(Platform::FindFile("05_17.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special4_.TrimFront(280);
    ballet_special4_.TrimBack(200);
    ballet_special4_.CalcRelativeTranslations();

    ballet_special5_.LoadFromAMC(Platform::FindFile("61_14.amc", searchPath_), *ballet_ant_.skeleton_ptr());
